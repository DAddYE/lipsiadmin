...
module LocalizationSimplified
  ...
  class ActiveRecord
    ...
    ErrorMessages = {
      ...
      :greater_than             => "deve essere maggiore di %d",
      :greater_than_or_equal_to => "deve essere maggiore o ugale di %d",
      :equal_to                 => "deve essere uguale a %d",
      :less_than                => "minore di %d",
      :less_than_or_equal_to    => "minore o uguale di %d",
