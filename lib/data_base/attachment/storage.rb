module Lipsiadmin
  module Attachment
    module Storage
      ...
      module Filesystem
        ...
        def flush_writes #:nodoc:
          ...
          @queued_for_write.each do |style, file|
            file.close
            logger.info "[Attachment] Directory for file is #{File.dirname(path(style))}"
        ...
        def flush_deletes #:nodoc:
          logger.info("[Attachment] Deleting files for #{name}")
          @queued_for_delete.each do |path|
            ...
            begin
              ...
              logger.info("[Attachment] There was an unexpected error while deleting directories: #{e.class}")
              # Ignore it
            end
          end
          @queued_for_delete = []
      ...
      #   Attachment will attempt to create it. The bucket name will not be interpolated.
