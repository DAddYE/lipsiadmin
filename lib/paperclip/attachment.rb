module Paperclip
  ...
  class Attachment
    ...
    attr_reader :name, :instance, :original_instance, :styles, :default_style
    ...
    def flush_reload #:nodoc:
      @instance[:"#{@name}_file_name"]    = @original_instance[:"#{@name}_file_name"]    
      @instance[:"#{@name}_content_type"] = @original_instance[:"#{@name}_content_type"] 
      @instance[:"#{@name}_file_size"]    = @original_instance[:"#{@name}_file_size"]    
    end
